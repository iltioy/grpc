...
type GreetServiceClient interface {
	...
	SayHelloBiderectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiderectionalStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBiderectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBiderectionalStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBiderectionalStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBiderectionalStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBiderectionalStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBiderectionalStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBiderectionalStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiderectionalStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBiderectionalStreaming(GreetService_SayHelloBiderectionalStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBiderectionalStreaming(GreetService_SayHelloBiderectionalStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBiderectionalStreaming not implemented")
}
...
func _GreetService_SayHelloBiderectionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiderectionalStreaming(&greetServiceSayHelloBiderectionalStreamingServer{stream})
}

type GreetService_SayHelloBiderectionalStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBiderectionalStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBiderectionalStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBiderectionalStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBiderectionalStreaming",
			Handler:       _GreetService_SayHelloBiderectionalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
